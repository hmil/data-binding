...
import { SvelteComponent } from './framework';
import { seq } from '../utils/jsx';

export default class SvelteClock implements SvelteComponent{
    ...
    public render(): any {
        return <svg width="300" height="300" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="-101 -101 202 202">
            ...
            <text x="-20" y="50" fill="#000" fontFamily="helvetica" fontSize="13px">Svelte.</text>
            {/* hours needle */}
